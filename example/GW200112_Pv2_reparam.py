...
# first, fetch a 4s segment centered on GW200112
gps = 1262879936.0
duration = 4
...
plt.savefig("GW200112_Pv2_testing_reparam.jpeg")

###########################################
############# Save the Run ################
###########################################
import pickle
pickle.dump(result, open("GW200112_Pv2_reparam.pkl", "wb"), protocol=pickle.HIGHEST_PROTOCOL)